...
This branch contains post-training weight pruning experiments targeting neuromorphic hardware (Intel Loihi), where unstructured weight sparsity directly reduces active computation rather than being merely a compression artefact.
...
| Greedy + weight correction (`prune_cancellation.py`) | TBD | — | — | — | — | — | — |
